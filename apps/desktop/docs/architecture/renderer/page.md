...
// shared import
import { SharedButton } from '@/renderer/pages/shared/Button' // ✅ 상위 계층 shared 파일/폴더
...
- model 모듈에서는 store만 import할 수 있습니다.
  ...
  ```typescript
  import useTreeViewStore from '@/renderer/models/treeView/store' // ✅ model의 store

  import { useTreeStore } from '@/renderer/models/treeView/draggingNode' // ❌ model의 깊은 중첩 경로
  ```
