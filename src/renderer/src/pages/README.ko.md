...
이러한 원칙들을 달성하기 위해 다음과 같은 구조와 규칙을 사용합니다:

- 계층적 디렉토리 구조로 각 컴포넌트의 책임과 범위를 명확히 합니다
- Import 규칙으로 컴포넌트 간 의존성 방향을 제어합니다
...
의존성 관리와 유지보수성을 위해 다음과 같은 import는 금지됩니다:
